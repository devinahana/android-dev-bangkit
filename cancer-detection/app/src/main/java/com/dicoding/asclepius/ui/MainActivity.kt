                ...
                override fun onResults(results: List<Classifications>?, inferenceTime: Long) {
                    runOnUiThread {
                        if (results != null && results.isNotEmpty()) {
                            ...
                            intent.putExtra(ResultActivity.EXTRA_URI_IMAGE, currentImageUri.toString())
                            intent.putExtra(ResultActivity.EXTRA_CANCER_NAME, topResult?.label)
                            intent.putExtra(ResultActivity.EXTRA_CONFIDENCE_SCORE, topResult?.score)
                            startActivity(intent)
                        } else {
